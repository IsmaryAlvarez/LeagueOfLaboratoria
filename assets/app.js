...
function uploadFile() {
    ...
    console.log(file);
    //cuando creamos la referencia, si es que subiremos el archivo
    //a una carpeta, ponemos el nombre de ella, antes del archivo.
    var thisRef = storageRef.child("archivosSubidos/" + file.name);
